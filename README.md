...
const images = [{
    // Simplest usage.
    src: 'https://avatars2.githubusercontent.com/u/7970947?v=3&s=460',
...
| onSwipeDown            | function<br><br>`(boolean) => void`                                                    | no       | Callback for swipe down is finished                                                                                                                                                                                                  | `() => null`                                              |
| handlePanSwipeDown     | function<br><br>`(number) => void`                                                     | no       | Callback for handle swipe down with offset                                                                                                                                                                                           | `() => null`                                              |
